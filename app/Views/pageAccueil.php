...
<body>
    ...
    <div class="customer-carousel-wrapper">
      <div class="customer-story-container">
        ...
        <div class="text-section">
          ...
          <p class="description">
            “Depuis que j'utilise la Crème Baobab, ma peau est incroyablement lisse et lumineuse. C'est vraiment un
            miracle en pot !”
          </p>
        </div>
      </div>
      ...
      <div class="customer-story-container">
        ...
        <div class="text-section">
          ...
          <p class="description">
            “Le roll-on anti-cerne est absolument incroyable. Mes cernes et poches sont visiblement réduites et ma peau
            est plus ferme et rajeunie.”
          </p>
        </div>
      </div>
      <div class="customer-story-container">
        ...
        <div class="text-section">
          ...
          <p class="description">
            “Le Masque Clarifiant au Nila a complètement transformé ma routine de soins. Il nettoie en douceur et laisse
            ma peau fraîche et nette.”
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="faq-container">
    ...
    <?php if (!empty($faqs)): ?>
      ...
      foreach ($faqs as $faq):
        if ($count >= 2)
          break; // Arrêter après 2 questions
        $count++;
        ?>
        <div class="faq-item">
