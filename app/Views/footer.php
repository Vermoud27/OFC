    ...
    <div
        ...
        <div style="flex: 1; min-width: 200px; text-align: center;">
            <form>
                ...
                <button type="submit"
                    style="background-color: #FF7E42; color: white; border: none; padding: 5px 10px; border-radius: 10px; cursor: pointer; margin: 10px;">S'inscrire</button>
            </form>
        </div>
        ...
        <div style="flex: 2; justify-content: center; align-items: center;">
            ...
            <a href="https://www.instagram.com/ofcnaturel/" target="_blank" title="Instagram OFC Naturel">
                <img src="/assets/img/logo/instagram.png" alt="Logo Instagram"
                    style="width: 40px; height: 40px;margin: 0 10px;">
            </a>

            <a href="https://www.facebook.com/ofcnaturel/" target="_blank" title="Facebook OFC Naturel">
                <img src="/assets/img/logo/facebook.png" alt="Logo Facebook"
                    style="width: 40px; height: 40px;margin: 0 10px;">
            </a>
        </div>
        ...
        <div style="flex: 1; min-width: 200px; text-align: right;">
            <ul style="list-style-type: none; padding: 0; margin: 0;">
                ...
                <li><a href="#" style="color: white; text-decoration: none;">Politique de retour et remboursement</a>
                </li>
